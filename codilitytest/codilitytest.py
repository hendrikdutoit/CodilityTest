...
class CodilityTest:
    ...
    def method_1( self ):
        '''Method description
        '''
        print( colored( 'Testing CodilityTest...', 'yellow' ))
        return True
...
def init_logger():
    logger = logging.getLogger(CodilityTest)
...
if __name__ == '__main__':
    ...
    t_codilitytest = CodilityTest(ini_pth)
    if t_codilitytest.success:
        t_codilitytest.run()
    b_tls.print_footer()
# end __main__
