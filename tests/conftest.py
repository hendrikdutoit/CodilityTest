...
'''.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/codilitytest
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/codilitytest

'''
_INDEX_RST_BADGE_GITHUB_CI = \
'''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/codilitytest/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/codilitytest/actions/workflows/ci.yaml

'''
_INDEX_RST_BADGE_GITHUB_HITS = \
'''.. image:: https://img.shields.io/github/search/hendrikdutoit/codilitytest/GitHub hit
    :alt: GitHub Searches

'''
_INDEX_RST_BADGE_GITHUB_LICENSE = \
'''.. image:: https://img.shields.io/github/license/hendrikdutoit/codilitytest
    :alt: License

'''
_INDEX_RST_BADGE_GITHUB_ISSUES = \
'''.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/codilitytest
    :alt: GitHub issues

'''
_INDEX_RST_BADGE_GITHUB_PRE_COMMIT = \
'''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/codilitytest/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/codilitytest/actions/workflows/pre-commit.yaml

'''
_INDEX_RST_BADGE_GITHUB_RELEASE = \
'''.. image:: https://img.shields.io/github/v/release/hendrikdutoit/codilitytest
    :alt: GitHub release (latest by date)

'''
_INDEX_RST_BADGE_PYPI_VERSION = \
'''.. image:: https://img.shields.io/testpypi/v/codilitytest
    :alt: PyPi

'''
_INDEX_RST_BADGE_PYPI_DL = \
'''.. image:: https://img.shields.io/pypi/dm/codilitytest
    :alt: PyPI - Downloads

'''
_INDEX_RST_BADGE_PYPI_STATUS = \
'''.. image:: https://img.shields.io/pypi/status/codilitytest
    :alt: PyPI - Status

'''
_INDEX_RST_BADGE_PYPI_WHEEL = \
'''.. image:: https://img.shields.io/pypi/wheel/codilitytest
    :alt: PyPI - Wheel

'''
_INDEX_RST_BADGE_PYVERSIONS = \
'''.. image:: https://img.shields.io/pypi/pyversions/codilitytest
